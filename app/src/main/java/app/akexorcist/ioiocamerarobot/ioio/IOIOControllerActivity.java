...
public class IOIOControllerActivity extends IOIOActivity implements CameraManager.CameraManagerListener, Callback, ConnectionManager.ConnectionListener, ConnectionManager.ControllerCommandListener, ConnectionManager.SendCommandListener {
    ...
    public ImageView ivCameraImage2;
    public ImageView iv;
    ...
    public InetAddress CONTROLLER_IP;
...
//
        ivCameraImage2 = (ImageView) findViewById(R.id.iv_camera_image2);
//        iv = (ImageView) findViewById(R.id.iv);
        ...
        connectionManager = new ConnectionManager(password,this);
  ...
  //      cameraManager.createCameraInstance(); //start preview

        //Create sending audio thread here
        StartAudio();
        ...
        Thread streamThread = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    android.util.Log.d("VS", "Recorder initialized");
                    ...
                    while(1==1){
                        if(CONTROLLER_IP!=null){
                            ...
                            String temp = CONTROLLER_IP.toString().substring(1);
                            InetAddress address = InetAddress.getByName(CONTROLLER_IP.toString().substring(1));
                            audiopacket = new DatagramPacket (buffer,buffer.length, address,CONTROLLER_PORT); //CONTROLLER_IP
