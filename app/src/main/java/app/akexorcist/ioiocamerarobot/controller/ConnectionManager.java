...
public class ConnectionManager {
    ...
    private app.akexorcist.ioiocamerarobot.ioio.ConnectionManager.SendCommandListener sendListener;
        ...
        new Thread(new Runnable() {
            public void run() {
                try {
                    ...
                    Log.d("CONTROLLER: ", str+": data length:"+data.length);
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
